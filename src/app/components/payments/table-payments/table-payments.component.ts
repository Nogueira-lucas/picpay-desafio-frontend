...
import { TablePaymentsDataSource, TablePaymentsItem } from './table-payments-datasource';
...
export class TablePaymentsComponent implements AfterViewInit {
  ...
  @ViewChild(MatTable) table!: MatTable<TablePaymentsItem>;
  ...
  constructor() {
    this.dataSource = new TablePaymentsDataSource();
  }
